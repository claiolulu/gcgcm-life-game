                  ...
                  <>
                    <div onClick={v.pageTap} style={{flex: "1", minHeight: "0", position: "relative", overflow: "hidden", background: v.paper, display: "flex", flexDirection: "column"}}>
                      ...
                      <div style={{position: "relative", zIndex: "5", flex: "none", display: "flex", alignItems: "center", gap: "6px", padding: "12px 10px 8px", borderBottom: "1px solid rgba(var(--pp-ink-rgb),.4)"}}>
                        <button onClick={v.togglePush} data-tour="notify" aria-label={v.pushLabel} title={v.pushLabel} style={{flex: "none", width: "30px", height: "30px", border: "1px solid rgba(var(--pp-ink-rgb),.35)", display: "flex", alignItems: "center", justifyContent: "center", color: "var(--pp-ink)", background: v.pushOn ? "rgba(var(--pp-ink-rgb),.12)" : "transparent"}}>
                      ...
                      {v.isClosing ? (
                        <>
                          <div style={{position: "relative", zIndex: "4", flex: "1", minHeight: "0", overflow: "auto", padding: "20px 20px 18px", display: "flex", flexDirection: "column", gap: "18px"}}>
                            ...
                            <button onClick={v.goBadge} style={{marginTop: "auto", padding: "15px", background: "var(--pp-ink)", border: "1px solid rgba(var(--pp-gold-2-rgb),.6)", color: "var(--pp-gold)", fontFamily: "'EB Garamond',serif", fontSize: "12px", letterSpacing: ".24em", textIndent: ".24em"}} style-active="opacity:.85">
                              BADGE 我的徽章
                            </button>
                            <button onClick={v.goBoard} style={{marginTop: "10px", padding: "13px", background: "transparent", border: "1px solid rgba(var(--pp-ink-rgb),.45)", color: "var(--pp-ink)", fontFamily: "'EB Garamond',serif", fontSize: "11.5px", letterSpacing: ".18em", textIndent: ".18em"}}>
                              RANKING 查看排名
                            </button>
                          </div>
                        </>
